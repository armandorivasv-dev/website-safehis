...
export default async function handler(req, res) {
  ...
  limiter(req, res, async () => {
    ...
    if (req.method === 'POST') {
      ...
      sendSmtpEmail.to = [{ email: 'safehis.platform@gmail.com' }];
      //sendSmtpEmail.to = [{ email: email }];

      sendSmtpEmail.sender = { email: 'safehis.platform@gmail.com', name: 'Safehis' };
    ...
    `;
      ...
      <h2><strong>Mensaje de "${fullname}" enviado desde el Formulario de Contacto en safehis</strong></h2>
      <br>
      <hr>     
